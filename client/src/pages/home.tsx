  ...
  return (
    <Box>
      ...
      <Box mt="20px" display="flex" flexWrap="wrap" gap={4}>
        ...
        <PieChart title="Properties for Rent" value={546} series={[60, 40]} colors={["#FD8539", "#E4E8EF"]} />
        <PieChart title="Total Customer" value={5732} series={[75, 25]} colors={["#2ED480", "#E4E8EF"]} />
        <PieChart title="Total City" value={90} series={[80, 20]} colors={["#FE6D8E", "#E4E8EF"]} />
      </Box>
      ...
      <Stack mt="25px" width="100%" flexWrap="wrap" direction="row" gap={4}>
        <Box flex={1} borderRadius="15px" padding="20px" bgcolor="#FCFCFC" display="flex" flexDirection="column" minWidth={{ xs: "100%", sm: 450 }}>
