        ...
        <form style={{ marginTop: "20px", width: "100%", display: "flex", flexDirection: "column", gap: "20px" }} onSubmit={handleSubmit(onFinishHandler)}>
          ...
          <Stack direction="row" gap={4}>
            <FormControl sx={{ flex: 1 }}>
              ...
              <Select variant="outlined" color="info" displayEmpty required inputProps={{ "aria-label": "Without label" }} defaultValue="aparment" {...register("propertyType", { require: true })}>
            ...
            <FormControl>
              ...
              <TextField fullWidth required id="outlined-basic" color="info" type="number" variant="outlined" {...register("price", { require: true })} />
            </FormControl>
          </Stack>
          <FormControl>
