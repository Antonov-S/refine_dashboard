        ...
        <Box width="100%" flex={1} maxWidth={326} display="flex" flexDirection="column" gap="20px">
          <Stack width="100%" p={2} direction="column" justifyContent="center" alignItems="center" border="1px solid #E4E4E4" borderRadius={2}>
            <Stack mt={2} justifyContent="center" alignItems="center" textAlign="center">
              <img src={propertyDetails.creator.avatar} width={90} height={90} style={{ borderRadius: "100%", objectFit: "cover" }} alt={propertyDetails.creator.name} />
          ...
          <Stack>
            <img src="https://serpmedia.org/scigen/images/googlemaps-nyc-standard.png?crc=3787557525" width="100%" height={306} style={{ borderRadius: 10, objectFit: "cover" }} alt="mapPhoto" />
          </Stack>
