import { Add, PlaylistAddCheckCircleRounded } from "@mui/icons-material";
    ...
    <Box>
      ...
      {allProperties.length > 0 && (
        <Box display="flex" gap={2} mt={3} flexWrap="wrap">
          ...
          <Select variant="outlined" color="info" displayEmpty required inputProps={{ "aria-lebel:": "Without label" }} defaultValue={10} onChange={e => setPageSize(e.target.value ? Number(e.target.value) : 10)}>
